...
Comprehensive codebase exploration agent - finds WHERE code lives AND shows HOW it's implemented with concrete examples. Locates files, maps structure, and extracts patterns with precise file:line references.

**Use with Task tool**: `subagent_type="Explore"` or invoke as specialized agent.
