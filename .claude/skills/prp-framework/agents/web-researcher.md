...
Need information beyond your training data? Modern docs, recent APIs, or current best practices? Use web-researcher to find answers from the web. Searches strategically, fetches relevant content, and synthesizes findings with proper citations.

**Use with Task tool**: `subagent_type="general-purpose"` with research instructions, or use WebSearch/WebFetch tools directly.
...
### For LLM-optimized Docs (llms.txt)
